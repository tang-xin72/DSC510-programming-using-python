#DSC 510-301
#Week 4, Programming Assignment Week 4
#Author Xin Tang
#4/5/2023
...
#date of change: 3/21/2023
#Change #3: add if to apply discount per length before calculate the install cost
#date of change: 3/29/2023
#Change #4: add function install_cost_cal to calculate install cost with discount per length
#date of change: 4/4/2023
#change #5: add main() function
#date of change: 4/5/2023
...
def main():
 ...
 #select install unit price based on length
 if length_val <= 100:
    unit_cost = 0.87
 elif length_val <=250:
    unit_cost = 0.8
